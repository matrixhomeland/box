...
public abstract class EnvironmentImpl implements Serializable, Environment {
  ...
  public abstract Object get(String name,String[] searchOrder, boolean nullAllowed) throws BoxException;
  
  public abstract Object get(String name, boolean nullAllowed) throws BoxException;
...
public static <T> T getFromCurrent(Class<T> type, boolean required) {
    ...
    if (environment==null) {
      if (required) {
        throw new BoxException("no environment to get "+type.getName());
      }
      return null;
    }
    ...
    if (object==null) {
      if (required) {
        throw new BoxException("no "+type.getName()+" in current environment");
      }
      return null;
    }
    return object;
  ...
  public static Object getFromCurrent(String name, boolean required) {
    ...
    if (environment==null) {
      if (required) {
        throw new BoxException("no environment to get '"+name+"'");
      }
      return null;
    }
    ...
    if (object==null) {
      if (required) {
        throw new BoxException("no '"+name+"' in current environment");
      }
      return null;
    }
    return object;
