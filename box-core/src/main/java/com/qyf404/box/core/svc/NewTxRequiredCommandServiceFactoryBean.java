 ...
 * @since 2014年12月6日
 */
@Named("newTxRequiredCommandService")
public class NewTxRequiredCommandServiceFactoryBean extends RequiredCommandServiceFactoryBean implements FactoryBean<CommandService> {
	...
	public CommandService getObject() throws Exception {
		...
		environmentInterceptor.setPolicy(Policy.REQUIRES_NEW);
